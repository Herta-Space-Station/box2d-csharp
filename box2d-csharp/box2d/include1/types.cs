...
namespace Box2d
{
    ...
    public unsafe struct b2WorldDef
    {
        ...
        [NativeType(typeof(b2FrictionCallback))]
        public delegate* managed<float, int, float, int, float> frictionCallback;

        /// Optional mixing callback for restitution. The default uses max(restitutionA, restitutionB).
        [NativeType(typeof(b2RestitutionCallback))]
        public delegate* managed<float, int, float, int, float> restitutionCallback;
        ...
        [NativeType(typeof(b2EnqueueTaskCallback))]
        public delegate* managed<delegate* managed<int, int, uint, void*, void>, int, int, void*, void*, void*> enqueueTask;

        /// Function to finish a task
        [NativeType(typeof(b2FinishTaskCallback))]
        public delegate* managed<void*, void*, void> finishTask;
    ...
    public unsafe struct b2Counters
    {
    ...
    public unsafe struct b2DistanceJointDef
    {
    ...
    /// @ingroup motor_joint
    public unsafe struct b2MotorJointDef
    {
        /// The first attached body
        public b2BodyId bodyIdA;
    ...
    /// @ingroup mouse_joint
    public unsafe struct b2MouseJointDef
    {
    ...
    public unsafe struct b2FilterJointDef
    {
        /// The first attached body.
        public b2BodyId bodyIdA;
    ...
    public unsafe struct b2PrismaticJointDef
    {
        /// The first attached body
        public b2BodyId bodyIdA;
    ...
    /// @ingroup weld_joint
    public unsafe struct b2WeldJointDef
    {
        /// The first attached body
        public b2BodyId bodyIdA;
    ...
    /// when the local anchor points coincide in world space.
    /// @ingroup wheel_joint
    public unsafe struct b2WheelJointDef
    {
        /// The first attached body
        public b2BodyId bodyIdA;
    ...
    public unsafe struct b2SensorEvents
    {
    ...
    public unsafe delegate bool b2PlaneResultFcn(b2ShapeId shapeId, b2PlaneResult* plane, void* context);
    ...
    public unsafe delegate void DrawPolygonFcn(b2Vec2* vertices, int vertexCount, b2HexColor color, void* context);

    public unsafe delegate void DrawSolidPolygonFcn(b2Transform transform, b2Vec2* vertices, int vertexCount, float radius, b2HexColor color, void* context);

    public unsafe delegate void DrawCircleFcn(b2Vec2 center, float radius, b2HexColor color, void* context);

    public unsafe delegate void DrawSolidCircleFcn(b2Transform transform, float radius, b2HexColor color, void* context);

    public unsafe delegate void DrawSolidCapsuleFcn(b2Vec2 p1, b2Vec2 p2, float radius, b2HexColor color, void* context);

    public unsafe delegate void DrawSegmentFcn(b2Vec2 p1, b2Vec2 p2, b2HexColor color, void* context);

    public unsafe delegate void DrawTransformFcn(b2Transform transform, void* context);
    ...
    public unsafe struct b2DebugDraw
    {
        ...
        [NativeType(typeof(DrawSolidPolygonFcn))]
        ...
        /// Draw a solid circle.
        [NativeType(typeof(DrawSolidCircleFcn))]
        public delegate* managed<b2Transform, float, b2HexColor, void*, void> DrawSolidCircleFcn;

        /// Draw a solid capsule.
        [NativeType(typeof(DrawSolidCapsuleFcn))]
